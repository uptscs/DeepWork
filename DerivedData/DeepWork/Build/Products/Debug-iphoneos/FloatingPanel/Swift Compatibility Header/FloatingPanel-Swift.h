// Generated by Apple Swift version 5.0 effective-4.2 (swiftlang-1001.0.60.3 clang-1001.0.37.8)
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FloatingPanel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13FloatingPanel13FloatingPanel")
@interface FloatingPanel : NSObject <UIGestureRecognizerDelegate, UIScrollViewDelegate>
...
- (void)handleWithPanGesture:(UIPanGestureRecognizer * _Nonnull)panGesture;
...
SWIFT_CLASS("_TtC13FloatingPanel25FloatingPanelBackdropView")
...
SWIFT_CLASS("_TtC13FloatingPanel23FloatingPanelController")
...
SWIFT_CLASS("_TtC13FloatingPanel35FloatingPanelModalDismissTransition")
@interface FloatingPanelModalDismissTransition : NSObject <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC13FloatingPanel35FloatingPanelModalPresentTransition")
@interface FloatingPanelModalPresentTransition : NSObject <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13FloatingPanel28FloatingPanelModalTransition")
@interface FloatingPanelModalTransition : NSObject <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC13FloatingPanel33FloatingPanelPanGestureRecognizer")
...
SWIFT_CLASS("_TtC13FloatingPanel28FloatingPanelPassThroughView")
...
SWIFT_CLASS("_TtC13FloatingPanel35FloatingPanelPresentationController")
@interface FloatingPanelPresentationController : UIPresentationController
...
SWIFT_CLASS("_TtC13FloatingPanel31FloatingPanelSurfaceContentView")
@interface FloatingPanelSurfaceContentView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13FloatingPanel24FloatingPanelSurfaceView")
...
SWIFT_CLASS("_TtC13FloatingPanel31FloatingPanelSurfaceWrapperView")
@interface FloatingPanelSurfaceWrapperView : UIView
- (UIView * _Nullable)hitTest:(CGPoint)point withEvent:(UIEvent * _Nullable)event SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13FloatingPanel17GrabberHandleView")
...
@interface UIViewController (SWIFT_EXTENSION(FloatingPanel))
