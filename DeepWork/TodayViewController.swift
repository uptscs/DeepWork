...
class TodayViewController: UITableViewController {
    ...
    let activities = ["Lunch", "Break", "Rest", "Recreation","Work", "Commute", "Rest", "Tea/Coffee Break", "Reading"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let userDefault = UserDefaults(suiteName: "group.DeepWork")
        userDefault?.set("Upper Body Workout Session", forKey: "CurrentActivity")
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        showFullScreenView(forActivity: activity)
    }
    private func showFullScreenView(forActivity activity:String){
        ...
        let fullScreenVC = storyboard.instantiateViewController(withIdentifier: "FullScreenCounterViewController") as! FullScreenCounterViewController
            fullScreenVC.currentActivityTitle = activity
